            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="../ServletModelo?editar=si">

                            <input type="text" readonly="true" value='<% out.println("" + con.getResultado().getString("modelo_id")); %>' name="id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="marca_id" value='<% out.println("" + con.getResultado().getString("marca_id")); %>' id="nombre" placeholder="Ingresar ID de la Marca">
                            </div>
