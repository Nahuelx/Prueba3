<%-- 
    Document   : crear
    Created on : 06-06-2016, 09:22:00 PM
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="../ServletModelo">
                            ...
                            <div class="form-group">
                                <label for="nombre">ID de la Marca</label>
                                <input type="text" class="form-control" name="marca_id" id="marca_id" placeholder="Ingresar marca">
