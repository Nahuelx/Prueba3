            ...
            <div class="row">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista de Modelos</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <br>
                        <a href="crear.jsp" class="btn btn-primary">Nuevo Modelo</a>
                        <br><br>
                            ...
                            <tbody>
                                ...
                                if(request.getParameter("buscar")!=null){
                                    if(request.getParameter("buscar").isEmpty()){
                                        con.setConsulta("select m.*,b.nombre as marca from modelos m, marcas b where m.marca_id = b.marca_id and m.estado='Activo'");
                                    }
                                    else{
                                        String nombre = request.getParameter("buscar");
                                        con.setConsulta("select m.*,b.nombre as marca from modelos m, marcas b where m.marca_id = b.marca_id and m.estado='Activo' and m.nombre like '%" + nombre + "%'");
                                    }
                                }
                                else{
                                con.setConsulta("select m.*,b.nombre as marca from modelos m, marcas b where m.marca_id = b.marca_id and m.estado='Activo'");
                                ...
                                while(con.getResultado().next()){
                                    out.println("<tr>");
                                    out.println("<td>" + con.getResultado().getString("modelo_id") + "</td>");
                                    out.println("<td>" + con.getResultado().getString("nombre") + "</td>");
                                    out.println("<td>" + con.getResultado().getString("marca") + "</td>");
                                    out.println("<td><a href='../ServletModelo?eliminar=" + con.getResultado().getString("modelo_id") + "' class='btn btn-danger'>Eliminar</a>&nbsp;&nbsp;<a href='editar.jsp?editar=" + con.getResultado().getString("modelo_id") + "' class='btn btn-success'>Editar Modelo</a></td>");
                                    out.println("</tr>");
                                }
                                %>
                            </tbody>
